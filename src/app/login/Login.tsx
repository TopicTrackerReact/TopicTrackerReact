...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-around min-h-[70vh]">
      <div className="flex flex-col bg-slate-100 p-12 drop-shadow-xl m-auto rounded-lg mt-[15rem]">
        <h1 className="self-center text-lg">Log In</h1>
        <label>Email</label>
        <input required={true} type='email' ref={email} className="input h-8 bg-zinc-300 hover:bg-gray-300 hover:scale-105 hover:transition duration-200 drop-shadow focus:outline-none focus:bg-gray-300 focus:scale-105 focus:transition duration-200" />
        <label>Password</label>
        <input required={true} ref={password} type='password'
